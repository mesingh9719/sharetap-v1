...
<div class="max-w-4xl mx-auto">
    ...
    <header class="flex flex-col md:flex-row items-center mb-12 mt-6">
        <div class="relative mb-4 md:mb-0">
            <img src="{{ asset('assets/img/templates/clinic.jpg') }}" alt="Clinic" class="w-full h-64 object-cover rounded-lg shadow-md">
        </div>
        <div class="md:ml-8 text-center md:text-left">
            <h1 class="text-4xl font-bold mb-2">HealthCare Clinic</h1>
            <p class="text-xl text-gray-600">Your Health, Our Priority</p>
        </div>
    </header>
