<section class="relative overflow-hidden bg-gradient-to-r from-indigo-900 to-purple-900 py-20 px-4 sm:px-6 lg:px-8">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-transparent to-indigo-900 opacity-30"></div>
        <div class="absolute inset-0">
            <svg class="h-full w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="rgba(99, 102, 241, 0.2)" fill-opacity="1" d="M0,32L48,80C96,128,192,224,288,224C384,224,480,128,576,90.7C672,53,768,75,864,96C960,117,1056,139,1152,149.3C1248,160,1344,160,1392,160L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
            </svg>
        </div>
    </div>
